...
cockroach_sslmode = 'allow'
cockroach_sslrootcert = os.environ.get('DATABASE_SSLROOTCERT', '')
if cockroach_sslrootcert != '':
    cockroach_sslmode = 'verify-full'

DATABASES = {
    'default': {
        'ENGINE': 'django_cockroachdb',
        'NAME': os.environ.get('DATABASE_NAME', 'pbf'),
        ...
        'OPTIONS': {
            ...
            'sslrootcert': cockroach_sslrootcert,
        },
    }
}
